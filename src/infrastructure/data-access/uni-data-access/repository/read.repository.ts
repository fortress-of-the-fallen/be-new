...
import { IUniReadRepository } from 'src/application/interface/data-access/uni-data-access/repository/i-uni-read.repository';

type Condition<T> = FilterQuery<T>;
class ReadRepository<T extends IBaseEntity> implements IUniReadRepository<T> {
   constructor(
